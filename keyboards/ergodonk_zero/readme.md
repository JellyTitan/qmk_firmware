...
The left half must be connected to USB — the solenoid is wired to the left half's GP2 pin, so connecting USB to the right half will disable haptic feedback.
